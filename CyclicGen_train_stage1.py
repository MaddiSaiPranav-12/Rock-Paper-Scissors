...
flags.DEFINE_string('train_dir', './CyclicGen_checkpoints_stage1/',
                           """Directory where to write event logs """
                           """and checkpoint.""")
flags.DEFINE_string('train_image_dir', './voxel_flow_train_image/',
                           """Directory where to output images.""")
flags.DEFINE_string('test_image_dir', './voxel_flow_test_image_baseline/',
                           """Directory where to output images.""")
flags.DEFINE_string('subset', 'train',
                           """Either 'train' or 'validation'.""")
flags.DEFINE_string('pretrained_model_checkpoint_path', None,
...
flags.DEFINE_integer('training_data_step', 1, """The step used to reduce training data size""")
